function recommendation (temp,humidity,windspeed,category){
    ...
    else if((temp >= 0 && temp <=10) && (humidity >=70 && humidity <=90) && (windspeed <=20) && category == "Traveller"){
    ...
    else if((temp >= 0 && temp <=10) && (humidity >=70 && humidity <=90) && (windspeed <=20) && category == "Farmer"){
